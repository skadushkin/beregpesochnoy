...
namespace Drupal\oliverotest;

use Drupal\Core\Security\TrustedCallbackInterface;

/**
 * Implements trusted prerender callbacks for the oliverotest theme.
 *
 * @internal
 */
class oliverotestPreRender implements TrustedCallbackInterface {
