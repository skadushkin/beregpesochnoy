...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.oliverotest.areAnySubNavsOpen()) {
          props.oliverotest.closeAllSubNav();
        } else {
      ...
      if (e.key === 'Tab' && isNavOpen(props.navWrapper)) {
        ...
        if (e.shiftKey) {
          if (
            ...
            !props.oliverotest.isDesktopNav()
          ) {
    ...
    window.addEventListener('resize', () => {
      if (props.oliverotest.isDesktopNav()) {
        toggleNav(props, false);
      ...
      Drupal.oliverotest.closeAllSubNav();
    });
   ...
   */
  Drupal.behaviors.oliverotestNavigation = {
    attach(context) {
