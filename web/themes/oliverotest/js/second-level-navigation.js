...
((Drupal) => {
  const { isDesktopNav } = Drupal.oliverotest;
  ...
  Drupal.oliverotest.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.oliverotest.isDesktopNav()) return;
  ...
  Drupal.oliverotest.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.oliverotest.areAnySubNavsOpen = areAnySubNavsOpen;
