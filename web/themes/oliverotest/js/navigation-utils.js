...
((Drupal) => {
  ...
  Drupal.oliverotest.isDesktopNav = isDesktopNav;
  ...
  function setStickyHeaderStorage(expandedState) {
    ...
    localStorage.setItem(
      'Drupal.oliverotest.stickyHeaderState',
      JSON.stringify(item),
    );
  }
  ...
  function getStickyHeaderStorage() {
    ...
    if (now.getTime() > item.expiry) {
      ...
      localStorage.removeItem('Drupal.oliverotest.stickyHeaderState');
      return false;
    }
    return item.value;
  }
